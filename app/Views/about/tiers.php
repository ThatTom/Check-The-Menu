...
<html lang="en">
    <head>
        ...
        <title>Check The Menu - About</title>
        <!-- Favicon-->
        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-lg-5">
                    <a class="navbar-brand" href="index.html">Check The Menu</a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xxl-6">
                            <div class="text-center my-5">
                                ...
                                <p class="lead fw-normal text-muted mb-4">We think everyone should be able to find food and make a choice about what they want to eat instead of being told what they can and can't eat.</p>
