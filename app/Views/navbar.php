...
<div class="container-xl">
    ...
    <div class="nav-item dropdown">
        ...
        <span class="avatar avatar-sm" style="background-image: url(https://www.gravatar.com/avatar/<?php echo md5(auth()->user()->getEmail()); ?>)"></span>
        <div class="d-none d-xl-block ps-2">
            <div><?php echo auth()->user()->username; ?></div>
            <div class="mt-1 small text-muted">Award Level</div>
        </div>
        </a>
...
<div class="collapse navbar-collapse" id="navbar-menu">
    ...
    <div class="container-xl">
        ...
        <li class="nav-item">
            ...
            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-news" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">   <path stroke="none" d="M0 0h24v24H0z" fill="none"/>   <path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" />   <line x1="8" y1="8" x2="12" y2="8" />   <line x1="8" y1="12" x2="12" y2="12" />   <line x1="8" y1="16" x2="12" y2="16" /> </svg>
            </span>
            <span class="nav-link-title">
                News
            </span>
        ...
        <a href="" class="btn btn-primary" rel="noreferrer">
            <!-- Download SVG icon from http://tabler-icons.io/i/brand-github -->
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-book" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M3 19a9 9 0 0 1 9 0a9 9 0 0 1 9 0"></path><path d="M3 6a9 9 0 0 1 9 0a9 9 0 0 1 9 0"></path><path d="M3 6l0 13"></path><path d="M12 6l0 13"></path><path d="M21 6l0 13"></path></svg>
            Open Directory
        </a>
